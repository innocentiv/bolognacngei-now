...
const MembershipData: React.FC<IMembershipDataProps> = ({ match }) => {
  ...
  return member ? (
    <PageWrapper>
      ...
      >
        {({ isSubmitting, values, errors }: FormikProps<Values>) => {
          const isAdult = values.role === "adult";
          return (
            <Form className={classes.dataMemberForm}>
              <Field
                ...
                component={TextField}
              />
              <SelectField name="role" label="Fascia d'Età" errors={errors}>
                <MenuItem value="cub">Lupetto</MenuItem>
                <MenuItem value="scout">Exploratore</MenuItem>
              ...
              <SelectField
                ...
                errors={errors}
              >
                <MenuItem value="group1">
                  Bologna 1 "Atlantide" - Quartiere Reno-Borgo Panigale
                </MenuItem>
                <MenuItem value="group2">
                  Bologna 2 "Avalon" - Quartiere Savena
                </MenuItem>
                <MenuItem value="group3">
                  Bologna 3 "Valhalla" - Quartiere San Donato-San Vitale
                </MenuItem>
                <MenuItem value="group5">
                  Bologna 5 "Sherwood" - Quartiere Navile
                </MenuItem>
                <MenuItem value="clan">Clan "Sandoclan"</MenuItem>
                <MenuItem value="administrator">
                  Dirigente (CoS, Commissario, ecc)
                </MenuItem>
              </SelectField>
              ...
              <Field
                name="phone"
                type="text"
                label={isAdult ? "Telefono di contatto" : "Telefono del tutore"}
                component={TextField}
              />
